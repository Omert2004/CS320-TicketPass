...
public class PaymentAndTicketingService {
    ...
    public int processPayment(int userId, String lastFourDigits, String paymentToken, String status) {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            stmt.setString(4, status); // Now dynamically handles FAILED or SUCCESS
    ...
    public int retryPayment(int userId, String newLastFourDigits, String newPaymentToken, String status) {
        return processPayment(userId, newLastFourDigits, newPaymentToken, status);
    }
}